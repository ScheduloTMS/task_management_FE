...
import { authState } from "../../states/authState"; // adjust path if needed
import { getAllUsers } from "../../services/userService"; // adjust path if needed
...
const MessageSidebar = ({ onSelectUser }) => {
  ...
  useEffect(() => {
    const fetchUsers = async () => {
      try {
        const usersFromApi = await getAllUsers(token); // 👈 Use your service
