...
const TaskCardLayout = () => {
  ...
  const tasks = [
    { id: 1, taskName: 'Complete project documentation', dueDate: '20 March 2025', status: 'To Do' },
    ...
    { id: 4, taskName: 'Fix critical bugs', dueDate: '5 March 2025', status: 'Overdue' },
    { id: 5, taskName: 'Write unit tests', dueDate: '25 March 2025', status: 'To Do' },
